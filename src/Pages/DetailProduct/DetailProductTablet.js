...
import $ from "jquery";
import { Tablet } from "../../UI Components/MediaQuery/MediaQuery";
...
const DetailProductTablet = () => {
  ...
  return (
    <Tablet>
      ...
      <div className="DetailProduct-tablet">
        <div className="DetailProduct-backTop-tablet" onClick={slideUp}>
          <BsFillCaretUpFill />
        </div>
        <div className="DetailProduct-navigation-tablet">
          <h4>
            <BsArrowLeftShort />
        ...
        <div className="DetailProduct-detail-tablet">
          <div className="DetailProduct-detail-left-tablet">
            <div className="DetailProduct-detail-left-img-tablet">
              <div
                style={{
                  backgroundImage: `url(${
                ...
                className="DetailProduct-detail-left-productCard-img-tablet"
              ></div>
            </div>
          </div>
          <div className="DetailProduct-detail-right-tablet">
            <div className="DetailProduct-detail-right-title-tablet">
              <h1>{product.length >= 1 && product[0].name}</h1>
              <h4>$ {product.length >= 1 && product[0].price}</h4>

              <div className="DetailProduct-detail-right-size-tablet">
                <h4>Available sizes</h4>
                <div className="DetailProduct-detail-right-size-list-tablet">
                  {product.length >= 1 &&
              ...
              <button
                ...
                className={
                  holdSize !== ""
                    ? "DetailProduct-detail-right-add-tablet active"
                    : "DetailProduct-detail-right-add-tablet"
                }
              >
                ADD TO CART
              </button>
            </div>
            <div className="DetailProduct-detail-right-info-tablet">
              <h1>{product.length >= 1 && product[0].productTitle}</h1>
              <p>{product.length >= 1 && product[0].productSubtitle}</p>
            </div>
            <div className="DetailProduct-detail-right-detail-tablet">
              <h1>DETAILS</h1>
              <div className="DetailProduct-detail-right-detail-list-tablet">
                <span>
                  * Fit for{" "}
            ...
            <div className="DetailProduct-detail-right-note-tablet">
              <h1>Note :</h1>
        ...
        <div className="DetailProduct-reviews-tablet">
          <h1>REVIEWS</h1>
          <div className="DetailProduct-reviews-addButton-tablet">
            <div className="DetailProduct-reviews-addButton-list-tablet">
              <h4>
                <BsPerson /> 500
              </h4>
              <span>like this product</span>
            </div>
            <div className="DetailProduct-reviews-addButton-list-btn-tablet">
              <BsPlus />
              <h4>Add Reviews</h4>
            </div>
          </div>
          <div className="DetailProduct-reviews-listContainer-tablet">
            <div className="DetailProduct-reviews-list-tablet">
              <div className="DetailProduct-reviews-list-user-tablet">
                <div className="DetailProduct-reviews-list-user-icon-tablet">
                  <BsPerson />
                </div>
                <div className="DetailProduct-reviews-list-user-name-tablet">
...
export default DetailProductTablet;
