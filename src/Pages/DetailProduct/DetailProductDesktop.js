...
import $ from "jquery";
import { Desktop } from "../../UI Components/MediaQuery/MediaQuery";
...
const DetailProductDesktop = () => {
  ...
  // console.log(`Cart : ${newData.cart.length}`);
  // console.log(`HoldSize : ${holdSize}`);
  // console.log(
  //   `itemSize: ${
  //     cartFilter !== undefined && cartFilter !== null && cartFilter.size
  //   }`
  // );
  // console.log(cartFilter);
  // console.log(`isAvailable : ${newData.isAvailable}`);

  return (
    <Desktop>
      <MetaData title={metaTitle} />
      <div className="DetailProduct">
        <div className="DetailProduct-backTop" onClick={slideUp}>
          <BsFillCaretUpFill />
        </div>
        <div className="DetailProduct-navigation">
          <h4>
            <BsArrowLeftShort />
        ...
        <div className="DetailProduct-detail">
          <div className="DetailProduct-detail-left">
            <div className="DetailProduct-detail-left-img">
              <div
                style={{
                  backgroundImage: `url(${
                ...
                className="DetailProduct-detail-left-productCard-img"
              ></div>
            </div>
          </div>
          <div className="DetailProduct-detail-right">
            <div className="DetailProduct-detail-right-title">
              <h1>{product.length >= 1 && product[0].name}</h1>
              <h4>$ {product.length >= 1 && product[0].price}</h4>
              <div className="DetailProduct-detail-right-size">
                <h4>Available sizes</h4>
                <div className="DetailProduct-detail-right-size-list">
                  {product.length >= 1 &&
              ...
              <button
                ...
                className={
                  holdSize !== ""
                    ? "DetailProduct-detail-right-add active"
                    : "DetailProduct-detail-right-add"
                }
              >
                ADD TO CART
              </button>
            </div>
            <div className="DetailProduct-detail-right-info">
              <h1>{product.length >= 1 && product[0].productTitle}</h1>
              <p>{product.length >= 1 && product[0].productSubtitle}</p>
            </div>
            <div className="DetailProduct-detail-right-detail">
              <h1>DETAILS</h1>
              <div className="DetailProduct-detail-right-detail-list">
                <span>
                  * Fit for{" "}
            ...
            <div className="DetailProduct-detail-right-note">
              <h1>Note :</h1>
        ...
        <div className="DetailProduct-reviews">
          <h1>REVIEWS</h1>
          <div className="DetailProduct-reviews-addButton">
            <div className="DetailProduct-reviews-addButton-list">
              <h4>
                <BsPerson /> 500
              </h4>
              <span>like this product</span>
            </div>
            <div className="DetailProduct-reviews-addButton-list-btn">
              <BsPlus />
              <h4>Add Reviews</h4>
            </div>
          </div>
          <div className="DetailProduct-reviews-listContainer">
            <div className="DetailProduct-reviews-list">
              <div className="DetailProduct-reviews-list-user">
                <div className="DetailProduct-reviews-list-user-icon">
                  <BsPerson />
                </div>
                <div className="DetailProduct-reviews-list-user-name">
              ...
              <div className="DetailProduct-reviews-list-emoticon">
                <span>
            ...
            <div className="DetailProduct-reviews-list">
              ...
              <div className="DetailProduct-reviews-list-emoticon">
                {/* <span><BsEmojiHeartEyes /> Useful</span> */}
                {/* <span><BsEmojiSmile /> Not bad</span> */}
                {/* <span><BsEmojiExpressionless /> Not Sure</span> */}
                <span>
