...
const CheckOutMobileLandscape = () => {
  ...
  return (
    <div className="CheckOut-Tablet">
      ...
      <div className="CheckOut-conainer-Tablet">
        <div className="CheckOut-ItemList-Tablet">
          <div className="CheckOut-ItemList-orderItem-Tablet" style={newData.proccessing === true ? { overflow: "unset", maxHeight: "fit-content" } : {}}>
          ...
          <div className="CheckOut-payment-Tablet">
            <div className="CheckOut-billing-Tablet">
              <div className="CheckOut-billing-paymenMethod-Tablet">
                <h1>Payment Method</h1>
                <div className="CheckOut-billing-paymenMethod-list-Tablet">
              ...
              <hr />
              <div className="CheckOut-billing-total-Tablet">
                <h4>Product</h4>
              ...
              <hr />
              <div className="CheckOut-billing-total-Tablet total">
                <h4>Total</h4>
                <h1>$ {totalItems === 0 ? 0 : newData.total}</h1>
              </div>
              {newData.proccessing !== true && (
                <div className="CheckOut-cart-btn-Tablet">
            ...
            <div className="CheckOut-discount-Tablet">
              <h1>Discount Code</h1>
              <div>
                <input
                  type="text"
...
export default CheckOutMobileLandscape;
