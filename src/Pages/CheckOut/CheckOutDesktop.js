    ...
    <div className="CheckOut">
      ...
      <div className="CheckOut-conainer">
        <div className="CheckOut-ItemList">
          <div className="CheckOut-ItemList-orderItem" style={newData.proccessing === true ? {overflow: 'unset', maxHeight: 'fit-content'} : {}}>
          ...
          <div className="CheckOut-payment">
            <div className="CheckOut-billing">
              <div className="CheckOut-billing-paymenMethod">
                <h1>Payment Method</h1>
                <div className="CheckOut-billing-paymenMethod-list">
              ...
              <hr />
              <div className="CheckOut-billing-total">
                <h4>Product</h4>
              ...
              <hr />
              <div className="CheckOut-billing-total total">
                <h4>Total</h4>
