...
const CheckOutListMobile = (props) => {
  ...
  return (
    <Mobile>
      <div className="CheckOutList-Mobile">
        <div
          style={{
          ...
          className="CheckOutList-img-Mobile"
          onClick={() => detailHendeler(dataItem.id)}
        >
          {!dataItem.image[0] && <BsCamera />}
        </div>
        <div className="CheckOutList-info-Mobile">
          <div className="CheckOutList-info-detail-Mobile">
            <div className="CheckOutList-info-DetailInfo-Mobile">
              <h1>{dataItem.title}</h1>
              <h2>{dataItem.gender} Originals</h2>
              <div className="CheckOutList-info-detail-size-Mobile ">
