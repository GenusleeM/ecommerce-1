...
const CheckOutListDesktop = (props) => {
    ...
    <Desktop>
      <div className="CheckOutList">
        <div
          ...
          className="CheckOutList-img"
          onClick={() => detailHendeler(dataItem.id)}
        >
          {!dataItem.image[0] && <BsCamera />}
        </div>
        <div className="CheckOutList-info">
          <div className="CheckOutList-info-detail">
            <div className="CheckOutList-info-DetailInfo">
              <h1>{dataItem.title}</h1>
              <h2>{dataItem.gender} Originals</h2>
              <div className="CheckOutList-info-detail-size ">
