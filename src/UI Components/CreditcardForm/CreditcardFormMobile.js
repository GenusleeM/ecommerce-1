...
import CardInfoFormMobile from "./CardInfoFormMobile";
import $ from "jquery";

export default function CreditcardFormMobile() {
   // Data Context Hooks
  ...
  return (
    <div className="CreditcardForm-Mobile">
      <div className="CreditcardFormCustomer-Mobile">
        {newData.creditcardForm !== true ? (
          <>
            ...
            <form>
              ...
              <label
                className="CreditcardFormCustomerAddress-Mobile"
              ...
              <label
                className="CreditcardFormCustomerAptNum-Mobile"
              ...
              <label style={phoneErr !== "" ? { color: "red" } : {}}>
                ...
                <div className="CreditcardFormCustomerPhone-Mobile">
                  <h4 className="CreditcardFormCustomerPhoneCode-Mobile">
                    {phCodeFlag !== "" && <img src={phCodeFlag} alt="Flag" />}(
                    {phCode > 0 ? `+${phCode}` : "+00"})
                  </h4>
                  <input
                    className="CreditcardFormCustomerPhoneNumber-Mobile"
                    type="number"
                    value={phone}
            ...
            {newData.login === true && (
              <div className="CreditcardFormCustomerBtn-Mobile">
