...
export default function CreditcardFormDesktop() {
  // Data Context Hooks
  ...
  return (
    <div className="CreditcardForm">
      <div className="CreditcardFormCustomer">
        {newData.creditcardForm !== true ? (
          <>
            ...
            <form>
              ...
              <label
                className="CreditcardFormCustomerAddress"
              ...
              <label
                className="CreditcardFormCustomerAptNum"
              ...
              <label style={phoneErr !== "" ? { color: "red" } : {}}>
                ...
                <div className="CreditcardFormCustomerPhone">
                  <h4 className="CreditcardFormCustomerPhoneCode">
                    {phCodeFlag !== "" && <img src={phCodeFlag} alt="Flag" />}(
                    {phCode > 0 ? `+${phCode}` : "+00"})
                  </h4>
                  <input
                    className="CreditcardFormCustomerPhoneNumber"
                    type="number"
                    value={phone}
