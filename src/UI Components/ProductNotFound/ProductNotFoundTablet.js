...
import { Tablet } from '../MediaQuery/MediaQuery';
import { BsShieldExclamation } from "react-icons/bs";
import { useNavigate } from 'react-router-dom';

const ProductNotFoundTablet = () => {
    // Redirected
    ...
    return (
        <Tablet>
            <div className='ProductNotFound-tablet'>
                <div id='loading' className='ProductNotFound-loading-tablet ProductNotFound-show'><h1>Find Product ...</h1></div>
...
export default ProductNotFoundTablet;
